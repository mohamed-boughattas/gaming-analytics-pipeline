"""Seed database with sample gaming data for demo purposes.

This module provides functionality to seed the DuckDB database with
sample gaming data, enabling demo and testing without requiring
a RAWG API key.
"""
...
SAMPLE_PLATFORMS = [
    ...
    },
    {
        ...
        "slug": "playstation-4",
        "games_count": 32000,
        "image_background": "https://example.com/ps4.jpg",
        "year_start": 2013,
        "year_end": None,
    },
    {
        ...
        "slug": "xbox-one",
        "games_count": 28000,
        "image_background": "https://example.com/xbox-one.jpg",
        "year_start": 2013,
        "year_end": 2020,
    },
    {
        ...
        "games_count": 45000,
        "image_background": "https://example.com/switch.jpg",
        "year_start": 2017,
        "year_end": None,
    },
    {
        ...
        "slug": "playstation-5",
        "games_count": 18000,
        "image_background": "https://example.com/ps5.jpg",
        "year_start": 2020,
        "year_end": None,
    },
    {
        ...
        "slug": "xbox-series-x",
        "games_count": 15000,
        "image_background": "https://example.com/xbox-series-x.jpg",
        "year_start": 2020,
        "year_end": None,
    },
]
...
def seed_database(db_path: str | Path | None = None) -> dict[str, int]:
    ...
    Args:
        db_path: Path to the DuckDB database file. If None, uses default.
    ...
    platforms_count = platforms_result[0] if platforms_result else 0
